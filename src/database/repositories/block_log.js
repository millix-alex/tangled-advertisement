    ...
    get(where) {
        return new Promise((resolve, reject) => {
            const {
                    sql,
                    parameters
                } = Database.buildQuery('SELECT * FROM advertisement_advertiser.advertisement_block_log',where);
    ...
    delete(where) {
        return new Promise((resolve, reject) => {
            ...
            const {
                      sql,
                      parameters
                  } = Database.buildQuery('DELETE FROM advertisement_advertiser.advertisement_block_log', where);
